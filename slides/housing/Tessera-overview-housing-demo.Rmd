...
author: Ryan Hafen, Stephen Elstrom, Amanda White
date: July 2, 2015
output: 
...
* U.S. Department of Defense Advanced Research Projects Agency (DARPA), XDATA program
* Division of Math Sciences CDS&E Grant, National Science Foundation
...
* Enable users to
    ...
    + fit statistical models, and
    + derive mission-critical insight
    + __with minimal lines of code__
* While providing
    + a familiar, interactive, desktop programming environment
...
* Consists primarily of two R packages:
    + datadr
    + trelliscope
* Open source 
* All the power of R is available to you 
* Developed by professionals who perform data analysis
* TODO: add image
...
* TODO: make this 2 columns and insert figures
...
Regardless of what's underneath, the interface remains the same
TODO: insert figures
...
## Begin Hands-on Demonstrations

* URL: http://goog.gl/something (TODO: update URL)
* Use Firefox or Chrome (not Internet Explorer or Safari)
* Security warning: untrusted connection

![](security_warnings2.jpg)
...
TODO: figure out line wrapping inside table

## `datadr` data representation

* Data are represented in key/value pairs
...
``` {r eval=FALSE}
# Read housing data
housing <- drRead.csv("TODO: fill in filename here")
```
...
* TODO: I'm not sure we have time to cover this
* drQuantile
* drAggregate
...
TODO: show example on Hadoop cluster here
...
* Plots can be created using base R graphics, ggplot, lattice, ... (TODO fill in here)
...
#         name2=cog(value2, desc="description")
#     )
}
