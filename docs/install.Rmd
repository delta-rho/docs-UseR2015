...
- [Housing example code](https://raw.githubusercontent.com/tesseradata/docs-UseR2015/gh-pages/slides/housing_example_code.R) (note that you can equivalently use the code in the slides)
- Taxi example code: link coming soon
