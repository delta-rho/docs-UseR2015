...
- [Taxi example code](https://raw.githubusercontent.com/tesseradata/docs-UseR2015/gh-pages/R/taxi.R) and link to [rate code information](http://www.nyc.gov/html/tlc/html/passenger/taxicab_rate.shtml)
...
<span class="label label-success">**Update:**</span> it appears there may be some issues with github rate limiting at the conference.  If you try the above `install_github` commands and get an error to the effect of "(403) Forbidden", we have made the github packages available at another location:
