...
**Update:** it appears there may be some issues with github rate limiting at the conference.  If you try the above `install_github` commands and get an error, we have made the github packages available at another location:
